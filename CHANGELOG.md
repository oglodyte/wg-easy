...
## [15.4.0+mir.2] - 2026-08-18

### Fixed

- Allow General settings—including the Prometheus toggle—to be saved without
  requiring Routing-page health settings in the same request.
- Publish the `latest` container tag for stable fork releases.

## [15.4.0+mir.1] - 2026-08-15
